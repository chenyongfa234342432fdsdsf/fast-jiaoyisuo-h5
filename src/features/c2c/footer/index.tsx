...
function C2cFooter() {
  ...
  const tabBars: ITabBarItem[] = [
    ...
    {
      title: t`features_c2c_footer_index_jgmiqzhwo2`,
            ...
            <Link href={item.href}>
              <div className={classNames('tab-bar-content')}>
                <Icon
                  ...
                  hasTheme={!item.onlyIcon && pathname !== item.href}
                  name={pathname === item.href || item.onlyIcon ? item.hoverIcon : item.icon}
                />
