import {
  decimal_default,
  require_lodash
} from "./chunk-N36QPRJ3.js";
import {
  __export,
  __toESM
} from "./chunk-S5KM4IGW.js";

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/decimal/index.js
var decimal_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/market/index.js
var market_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/fast-url/index.js
...
function getFastUrl(url) {
  ...
  if (url.includes(originS3Domain)) {
    var _url;
    url = (_url = url) === null || _url === void 0 ? void 0 : _url.replace(originS3Domain, fastS3Domain);
    return url;
  }
  if (url.includes(fastS3DomainOld)) {
    var _url2;
    url = (_url2 = url) === null || _url2 === void 0 ? void 0 : _url2.replace(fastS3DomainOld, fastS3Domain);
    return url;
  }
  if (url.includes(originOSSDomain)) {
    var _url3;
    url = (_url3 = url) === null || _url3 === void 0 ? void 0 : _url3.replace(originOSSDomain, fastOSSDomain);
    return url;
  }
  if (url.includes(originProdS3Domain)) {
    var _url4;
    url = (_url4 = url) === null || _url4 === void 0 ? void 0 : _url4.replace(originProdS3Domain, fastProdS3Domain);
    return url;
  }
  if (url.includes(originTestS3Domain)) {
    var _url5;
    url = (_url5 = url) === null || _url5 === void 0 ? void 0 : _url5.replace(originTestS3Domain, fastTestS3Domain);
    return url;
  }
  if (url.includes(originDevS3Domain)) {
    var _url6;
    url = (_url6 = url) === null || _url6 === void 0 ? void 0 : _url6.replace(originDevS3Domain, fastDevS3Domain);
    return url;
  }
  if (url.includes(originDevS3ProdUploadDomain)) {
    var _url7;
    url = (_url7 = url) === null || _url7 === void 0 ? void 0 : _url7.replace(originDevS3ProdUploadDomain, fastDevS3ProdUploadDomain);
    return url;
  }
  if (url.includes(originDevS3DevUploadDomain)) {
    var _url8;
    url = (_url8 = url) === null || _url8 === void 0 ? void 0 : _url8.replace(originDevS3DevUploadDomain, fastDevS3DevUploadDomain);
    return url;
  }
  return url;
}
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/security/index.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/env/index.js
var env_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/vite-plugins/index.js
var vite_plugins_exports = {};
__export(vite_plugins_exports, {
  cssModuleHMR: () => cssModuleHMR
});

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/vite-plugins/cssHmr.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.32/node_modules/@nbit/utils/es/index.js
setPrecision(40);
export {
